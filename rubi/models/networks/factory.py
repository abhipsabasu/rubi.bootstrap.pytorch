...
def factory(engine):
    ...
    if opt['name'] == 'baseline':
        txt_enc = opt['txt_enc']
        awid_to_ans = torch.load(os.path.join('data', 'vqa', 'vqacp2', 'processed', 'nans,3000_minwcount,0_nlp,mcb_proc_split,train',
                                'awid_to_ans.pth'))
        ans_to_awid = torch.load(os.path.join('data', 'vqa', 'vqacp2', 'processed', 'nans,3000_minwcount,0_nlp,mcb_proc_split,train', 'ans_to_awid.pth'))
